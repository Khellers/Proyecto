...
{
    public class profesoressesController : Controller
    {
        ...
        // GET: profesoresses/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: profesoresses/Create
